...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-ggplot2-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-ggplot2-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-ggplot2-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-ggplot2-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-ggplot2-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-ggplot2-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-ggplot2/badges/version.svg)](https://anaconda.org/conda-forge/r-ggplot2)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-ggplot2/badges/downloads.svg)](https://anaconda.org/conda-forge/r-ggplot2)
